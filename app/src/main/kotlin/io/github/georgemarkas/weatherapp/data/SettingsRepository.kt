...
class SettingsRepository @Inject constructor(
    ...
    private object Keys {
        ...
        val SPECIFIED_LOCATION = booleanPreferencesKey("specific_location")
    }
    ...
    val settingsFlow: Flow<Settings> = context.settingsDataStore.data.map { preferences ->
        Settings(
            ...
            specifiedLocation = preferences[Keys.SPECIFIED_LOCATION] ?: false
        )
    }
    ...
    suspend fun setSpecifiedLocation(enabled: Boolean) {
        context.settingsDataStore.edit { it[Keys.SPECIFIED_LOCATION] = enabled }
    }
}